...
parser.add_argument("--ckpt-dir", action="append", type=str, help="Path to directory with stable diffusion checkpoints")
parser.add_argument("--vae-dir", action="append", type=str, help="Path to directory with VAE files")
...
parser.add_argument("--embeddings-dir", action="append", type=str, help="embeddings directory for textual inversion (default: embeddings)")
parser.add_argument("--textual-inversion-templates-dir", type=str, default=os.path.join(script_path, 'textual_inversion_templates'), help="directory with textual inversion templates")
parser.add_argument("--hypernetwork-dir", action="append", type=str, help="hypernetwork directory")
