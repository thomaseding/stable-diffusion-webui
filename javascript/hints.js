...
var file_patterns = "[steps], [cfg], [denoising], [clip_skip], [batch_number], [generation_number], [prompt_hash], [prompt], [prompt_no_styles], [prompt_spaces], [width], [height], [styles], [sampler], [seed], [model_hash], [model_name], [prompt_words], [date], [datetime], [datetime<Format>], [datetime<Format><Time Zone>], [job_timestamp], [hasprompt<prompt1|default><prompt2>..], [counter]"
...
var titles = {
    ...
    "Images filename pattern": "Use following tags to define how filenames for images are chosen: " + file_patterns + "; leave empty for default.",
    "Directory name pattern": "Use following tags to define how subdirectories for images and grids are chosen: " + file_patterns + "; leave empty for default.",
